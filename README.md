...
- [fn.py](https://github.com/kachayev/fn.py) ★3063 - "Functional programming in Python: implementation of missing features to enjoy FP" (unmaintained since 2014).
- [toolz](https://github.com/pytoolz/toolz) ★3008 - "A functional standard library for Python".
- [funcy](https://github.com/suor/funcy) ★2428 - "A fancy and practical functional tools".
- [PyFunctional](https://github.com/EntilZha/PyFunctional) ★1760 - "Python library for functional programming with collections in a data pipeline style".
- [more-itertools](https://github.com/erikrose/more-itertools) ★1723 - "More routines for operating on iterables, beyond itertools".
- [returns](https://github.com/dry-python/returns) ★1525 - "Make your functions return something meaningful, typed, and safe!"
- [hask](https://github.com/billpmurphy/hask) ★823 - "Haskell language features and standard libraries in pure Python".
- [Pydash](https://github.com/dgilland/pydash) ★703 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
- [OSlash](https://github.com/dbrattli/oslash) ★551 - "Functors, Applicatives, And Monads in Python".
- [Effect](https://github.com/python-effect/effect) ★321 - "Effect isolation in Python, to facilitate more purely functional code".
- [Underscore.py](https://github.com/serkanyersen/underscore.py) ★276 - "A Python port of excellent javascript library underscore.js".
...
- [pyramda](https://github.com/jackfirth/pyramda) ★112 - "Python package supporting heavy functional programming through currying. Translation of the Ramda library from javascript to python".
...
- [Pyrsistent](https://github.com/tobgu/pyrsistent) ★1469 - "Persistent/Immutable/Functional data structures for Python".
- [Immutables](https://github.com/MagicStack/immutables) ★791 - "An immutable mapping type for Python."
- [Discodb](https://github.com/discoproject/discodb) ★94 - "An efficient, immutable, persistent mapping object".
...
- [pampy](https://github.com/santinic/pampy) ★3312 - "Pampy: The Pattern Matching for Python you always dreamed of."
...
- [apm](https://github.com/scravy/awesome-pattern-matching) ★40 - "Pattern Matching for Python 3.8+ in a simple, yet powerful, extensible manner."

#### Tranducers

- [Tranducers-Python](https://github.com/cognitect-labs/transducers-python) ★185 - "Transducers are composable algorithmic transformations".
...
- [RxPy](https://github.com/ReactiveX/RxPY) ★3740 - "Reactive Extensions for Python".
...
- [chainable](https://github.com/olirice/chainable) ★152 - "Method chaining built on generators".
- [python-lenses](https://github.com/ingolemo/python-lenses) ★166 - "A python lens library for manipulating deeply nested immutable structures".
- [ADT](https://github.com/jspahrsummers/adt) ★115 - Algebraic data types for Python
- [deal](https://github.com/orsinium/deal) ★116 - "Design by contract for Python with many validators support."
...
- [pixie](https://github.com/pixie-lang/pixie) ★2271 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
