...
- [toolz](https://github.com/pytoolz/toolz) ★3479 - "A functional standard library for Python".
- [fn.py](https://github.com/kachayev/fn.py) ★3086 - "Functional programming in Python: implementation of missing features to enjoy FP" (unmaintained since 2014).
- [funcy](https://github.com/suor/funcy) ★2515 - "A fancy and practical functional tools".
- [more-itertools](https://github.com/erikrose/more-itertools) ★1832 - "More routines for operating on iterables, beyond itertools".
- [PyFunctional](https://github.com/EntilZha/PyFunctional) ★1805 - "Python library for functional programming with collections in a data pipeline style".
- [returns](https://github.com/dry-python/returns) ★1625 - "Make your functions return something meaningful, typed, and safe!"
- [hask](https://github.com/billpmurphy/hask) ★825 - "Haskell language features and standard libraries in pure Python".
- [Pydash](https://github.com/dgilland/pydash) ★730 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
- [Expression](https://github.com/cognitedata/Expression) ★94 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
- [OSlash](https://github.com/dbrattli/oslash) ★562 - "Functors, Applicatives, And Monads in Python".
...
- [pfun](https://github.com/suned/pfun) ★75 - "Pure functional programming in python".
...
- [Pyrsistent](https://github.com/tobgu/pyrsistent) ★1508 - "Persistent/Immutable/Functional data structures for Python".
- [Immutables](https://github.com/MagicStack/immutables) ★824 - "An immutable mapping type for Python."
...
- [pampy](https://github.com/santinic/pampy) ★3368 - "Pampy: The Pattern Matching for Python you always dreamed of."
...
- [pixie](https://github.com/pixie-lang/pixie) ★2277 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
