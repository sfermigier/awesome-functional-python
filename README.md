...
- [toolz](https://github.com/pytoolz/toolz) ★3499 - "A functional standard library for Python".
- [fn.py](https://github.com/kachayev/fn.py) ★3093 - "Functional programming in Python: implementation of missing features to enjoy FP" (unmaintained since 2014).
- [funcy](https://github.com/suor/funcy) ★2528 - "A fancy and practical functional tools".
- [more-itertools](https://github.com/erikrose/more-itertools) ★1856 - "More routines for operating on iterables, beyond itertools".
- [PyFunctional](https://github.com/EntilZha/PyFunctional) ★1831 - "Python library for functional programming with collections in a data pipeline style".
- [returns](https://github.com/dry-python/returns) ★1655 - "Make your functions return something meaningful, typed, and safe!"
- [hask](https://github.com/billpmurphy/hask) ★822 - "Haskell language features and standard libraries in pure Python".
- [Pydash](https://github.com/dgilland/pydash) ★733 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
- [Expression](https://github.com/cognitedata/Expression) ★95 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
- [OSlash](https://github.com/dbrattli/oslash) ★563 - "Functors, Applicatives, And Monads in Python".
- [Effect](https://github.com/python-effect/effect) ★324 - "Effect isolation in Python, to facilitate more purely functional code".
...
- [pyramda](https://github.com/jackfirth/pyramda) ★117 - "Python package supporting heavy functional programming through currying. Translation of the Ramda library from javascript to python".
...
- [ziopy](https://github.com/miiohio/ziopy) ★27 - "ZIO for Python (with ZIO = A type-safe, composable library for async and concurrent programming in Scala)"
- [pfun](https://github.com/suned/pfun) ★76 - "Pure functional programming in python".
- [fnc](https://github.com/dgilland/fnc) ★97 - "Functional programming in Python with generators and other utilities".
- [unpythonic](https://github.com/Technologicat/unpythonic) ★35 - "Supercharge your Python with parts of Lisp and Haskell."

#### Immutable / persistent data structures

- [Pyrsistent](https://github.com/tobgu/pyrsistent) ★1518 - "Persistent/Immutable/Functional data structures for Python".
- [Immutables](https://github.com/MagicStack/immutables) ★827 - "An immutable mapping type for Python."
...
- [pampy](https://github.com/santinic/pampy) ★3370 - "Pampy: The Pattern Matching for Python you always dreamed of."
- [python-pattern-matching](https://github.com/grantjenks/python-pattern-matching) ★153 - "Python pattern matching like functional languages."
- [patmat](https://github.com/admk/patmat) ★32 - "Functional-style recursive pattern matching in Python. Crazy stuff."
- [apm](https://github.com/scravy/awesome-pattern-matching) ★81 - "Pattern Matching for Python 3.8+ in a simple, yet powerful, extensible manner."
...
- [RxPy](https://github.com/ReactiveX/RxPY) ★3850 - "Reactive Extensions for Python".
...
- [python-lenses](https://github.com/ingolemo/python-lenses) ★185 - "A python lens library for manipulating deeply nested immutable structures".
- [Glom](https://github.com/mahmoud/glom) ★1349 - "Python's nested data operator (and CLI), for all your declarative restructuring needs.".

#### Other / specialized

- [chainable](https://github.com/olirice/chainable) ★155 - "Method chaining built on generators".
- [deal](https://github.com/orsinium/deal) ★171 - "Design by contract for Python with many validators support."
...
- [Tydy](https://github.com/cyrus-/tydy) ★48 - "Tydy is a statically typed, functional-first programming language in the ML tradition. tydy is an implementation of Tydy as a Python library."
...
- [pixie](https://github.com/pixie-lang/pixie) ★2279 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
- [Pycket](https://github.com/pycket/pycket) ★214 - "A rudimentary Racket implementation using RPython".
