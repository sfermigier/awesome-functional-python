...
- [toolz](https://github.com/pytoolz/toolz) ★3472 - "A functional standard library for Python".
- [fn.py](https://github.com/kachayev/fn.py) ★3085 - "Functional programming in Python: implementation of missing features to enjoy FP" (unmaintained since 2014).
- [funcy](https://github.com/suor/funcy) ★2501 - "A fancy and practical functional tools".
- [more-itertools](https://github.com/erikrose/more-itertools) ★1815 - "More routines for operating on iterables, beyond itertools".
- [PyFunctional](https://github.com/EntilZha/PyFunctional) ★1802 - "Python library for functional programming with collections in a data pipeline style".
- [returns](https://github.com/dry-python/returns) ★1610 - "Make your functions return something meaningful, typed, and safe!"
- [hask](https://github.com/billpmurphy/hask) ★826 - "Haskell language features and standard libraries in pure Python".
- [Pydash](https://github.com/dgilland/pydash) ★728 - "The kitchen sink of Python utility libraries for doing "stuff" in a functional way. Based on the Lo-Dash Javascript library".
- [Expression](https://github.com/cognitedata/Expression) ★93 - "Pragmatic functional programming for Python inspired by F#". Successor of OSlash.
- [OSlash](https://github.com/dbrattli/oslash) ★561 - "Functors, Applicatives, And Monads in Python".
...
- [Pyrsistent](https://github.com/tobgu/pyrsistent) ★1506 - "Persistent/Immutable/Functional data structures for Python".
- [Immutables](https://github.com/MagicStack/immutables) ★823 - "An immutable mapping type for Python."
...
- [pampy](https://github.com/santinic/pampy) ★3363 - "Pampy: The Pattern Matching for Python you always dreamed of."
...
- [RxPy](https://github.com/ReactiveX/RxPY) ★3816 - "Reactive Extensions for Python".
...
- [python-lenses](https://github.com/ingolemo/python-lenses) ★179 - "A python lens library for manipulating deeply nested immutable structures".
- [chainable](https://github.com/olirice/chainable) ★153 - "Method chaining built on generators".
- [deal](https://github.com/orsinium/deal) ★162 - "Design by contract for Python with many validators support."
...
- [pixie](https://github.com/pixie-lang/pixie) ★2278 - "A lightweight and native lisp built in RPython". ([Discussion on HN](https://news.ycombinator.com/item?id=13420092))
